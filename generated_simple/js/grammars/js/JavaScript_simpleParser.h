...
class  JavaScript_simpleParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleProgram = 0, RuleStatement = 1, RuleExpressionStatement = 2, RuleExpression = 3, 
    RuleAssignmentExpression = 4, RuleFunctionCall = 5, RuleArgumentList = 6, 
    RuleIdentifier = 7, RuleLiteral = 8, RuleVariableDeclaration = 9, RuleFunctionDeclaration = 10, 
    RuleParameterList = 11, RuleIfStatement = 12, RuleForStatement = 13, 
    RuleForInitializer = 14, RuleWhileStatement = 15, RuleReturnStatement = 16, 
    RuleBlockStatement = 17
  };

  explicit JavaScript_simpleParser(antlr4::TokenStream *input);

  JavaScript_simpleParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~JavaScript_simpleParser() override;
